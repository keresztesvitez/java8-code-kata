...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> comparator = (Customer c1, Customer c2) -> c2.getBudget() - c1.getBudget();
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(comparator).map(Customer::getName).limit(3);
